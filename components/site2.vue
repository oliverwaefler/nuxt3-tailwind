    ...
    <div class="mx-auto px-4 sm:container">
      <div>
        ...
        <p class="text-body-color text-sm font-medium">
          ...
          ultrices lectus sem. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras
          ultrices lectus sem.
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras
          ultrices lectus sem.
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras
          ...
          <div class="relative rounded-lg bg-white p-8 shadow-lg sm:p-12">
            <form>
              ...
              <div>
                <button
                    type="submit"
                    class="bg-body-color bg-primary border-primary w-full rounded border p-3 text-black transition hover:bg-opacity-90"
                >
                  Send Message
                </button>
              </div>
